    ...
    def radio_value(self):
        if self.rdb1.isChecked():
           ...
           self.comando1()
             ...
             self.labelLenguaje.setText("Comando 12")
            #self.comando12() 
        elif self.rdb13.isChecked():
             self.labelLenguaje.setText("Comando 13")
            #self.comando13() 
        
        elif self.rdb14.isChecked():
             self.labelLenguaje.setText("Comando 14")
            #self.comando14()
             
        elif self.rdb15.isChecked():
             self.labelLenguaje.setText("Comando 15")
            #self.comando15() 

        elif self.rdb16.isChecked():
             self.labelLenguaje.setText("Comando 16")
            #self.comando16() 

        elif self.rdb17.isChecked():
             self.labelLenguaje.setText("Comando 17")
            #self.comando17() 

        elif self.rdb18.isChecked():
             self.labelLenguaje.setText("Comando 18")
            #self.comando18() 

        elif self.rdb19.isChecked():
             self.labelLenguaje.setText("Comando 19")
            #self.comando19() 

        elif self.rdb20.isChecked():
             self.labelLenguaje.setText("Comando 20")
            #self.comando20() 
